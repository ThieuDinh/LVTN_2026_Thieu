...
export const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    // Extract success registration message from URL query params
        ...
        <div className="space-y-8 my-auto">
          <div className="space-y-3">
            ...
            <p className="text-sm text-[#6B7F70] leading-relaxed">
              Kênh kết nối thương mại giúp người nông dân chuyển giao nông sản sạch trực tiếp tới bàn ăn mọi gia đình Việt.
            </p>
          </div>
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#6B7F70]">
              Đăng nhập tài khoản để tiếp tục mua sắm hoặc quản lý cửa hàng của bạn.
            </p>
          </div>

          {/* Success Notification */}
          {successMessage && (
            <div className="p-4 text-xs font-semibold text-[#5A8A6A] bg-[#F0F7F2] rounded-[8px] border border-[#D1DDD4] animate-fade-in">
              {successMessage}
            </div>
          )}
          ...
          <div className="text-center pt-2">
            <p className="text-sm text-[#6B7F70]">
              Chưa có tài khoản?{' '}
              <Link to="/register" className="font-semibold text-[#5A8A6A] hover:text-[#4d755a] transition-colors">
                Đăng ký ngay
              </Link>
            </p>
          </div>
